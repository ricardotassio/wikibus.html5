...
Ext.define('Ubibus.view.ToolbarMapa', {
    ...
    centralizaMapa: function(segmentedbutton, button, isPressed, options) {
    ...
    onMysegmentedbutton5Toggle: function(segmentedbutton, button, isPressed, options) {
    ...
    onOpcoesMapaPontoToggle: function(segmentedbutton, button, isPressed, options) {
    ...
    onBtnBuscaPontosTap: function(button, e, options) {
        //Exibe promp de confirmação
        Ext.Msg.prompt(null, 
        'Informe um local:',
        function(btn, text){
    ...
    onOpcoesMapaLinhaToggle: function(segmentedbutton, button, isPressed, options) {
        if(isPressed){
